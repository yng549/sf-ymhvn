({
    ...
    createPdfOutput: function (component, event, helper) {
      component.set("v.Spinner", "true");
      var action = component.get("c.createOutputPdfFile");
      action.setParams({
        orderId: component.get("v.recordId")
      });
      action.setCallback(this, function (response) {
    ...
    createPdfTransfer: function (component, event, helper) {
      component.set("v.Spinner", "true");
      var action = component.get("c.createTransferPdfFile");
      action.setParams({
        orderId: component.get("v.recordId")
      });
      action.setCallback(this, function (response) {
