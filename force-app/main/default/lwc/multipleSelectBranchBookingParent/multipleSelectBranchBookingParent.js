...
import getLstAccountByRecordType from '@salesforce/apex/CalendarBookingController.getLstAccountByRecordType';

export default class MultipleSelectBranchBookingParent extends LightningElement {
    @track selectedValue;
    ...
    connectedCallback() {
        setTimeout(() => {
            ...
            getLstAccountByRecordType().then(apiResponse => {
